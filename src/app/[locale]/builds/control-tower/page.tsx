...
import { BuildPreviewControlTower } from '@/components/builds/BuildPreviewControlTower'

export default async function ControlTowerBuildPage() {
    const t = await getTranslations('landing.builds.controlTower')
    ...
    return (
        <main className="py-20 md:py-28">
            <Container size="lg">
                ...
                {/* Preview realista (mock UI) */}
                <div className="mt-10 md:mt-12">
                    <BuildPreviewControlTower />
                </div>
