...
import { BuildPreviewWhatsappFollowup } from '@/components/builds/BuildPreviewWhatsappFollowup'

export default async function WhatsappFollowupBuildPage() {
    const t = await getTranslations('landing.builds.whatsappFollowup')
        ...
        <main className="py-20 md:py-28">
            <Container size="lg">
                <div className="flex items-center justify-between gap-4">
                    ...
                    <Link
                        href="/#contact?intent=whatsapp-followup"
                    ...
                    <Card className="p-6">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="mt-2 flex flex-wrap gap-2">
                                {['Next.js', 'TypeScript', 'Automations', 'Calendar'].map((x) => (
                        ...
                        <div className="mt-5">
                            ...
                            <div className="mt-2 flex flex-wrap gap-2">
                                {['WhatsApp', 'Google Calendar', 'Gmail', 'Sheets'].map((x) => (
                                    <span key={x} className="rounded-full px-3 py-1 text-xs bg-white/5 border border-white/10 text-white/70">
                                        {x}
                                    </span>
                                ))}
