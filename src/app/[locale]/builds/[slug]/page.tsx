        ...
        <main className="py-20 md:py-28">
            <Container size="lg">
                ...
                <div className="mt-10 md:mt-12 max-w-3xl">
                    ...
                    <div className="mt-6 grid gap-3">
                        <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-sm p-4">
                            <p className="text-xs font-mono text-white uppercase tracking-wider">Problema</p>
                            <p className="mt-1 text-white leading-relaxed">{problem}</p>
                        </div>

                        <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-sm p-4">
                            <p className="text-xs font-mono text-white uppercase tracking-wider">Resultado</p>
                            <p className="mt-1 text-white leading-relaxed">{outcome}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-10 grid md:grid-cols-2 gap-6">
                    <Card className="p-6">
                        <p className="text-xs font-mono text-white uppercase tracking-wider">Qué hace</p>
                    ...
                    <Card className="p-6">
                        <p className="text-xs font-mono text-white uppercase tracking-wider">Stack & Integraciones</p>

                        <div className="mt-4">
                            <p className="text-sm text-white">Tech</p>
                            <div className="mt-2 flex flex-wrap gap-2">
                                {build.tech.map((x) => (
                                    <span key={x} className="rounded-full px-3 py-1 text-xs bg-white/5 border border-white/10 text-white">
                                        {x}
                                    </span>
                                ))}
                            </div>
                        ...
                        <div className="mt-5">
                            <p className="text-sm text-white">Integrations típicas</p>
                            <div className="mt-2 flex flex-wrap gap-2">
