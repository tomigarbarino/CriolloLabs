...
export default async function PerfUxAuditBuildPage() {
    const t = await getTranslations('landing.builds.perfUxAudit')
        ...
        <main className="py-20 md:py-28">
            <Container size="lg">
                <div className="flex items-center justify-between gap-4">
                    ...
                    <Link
                        href="/#contact?intent=perf-ux-audit"
                    ...
                    <Card className="p-6">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="mt-2 flex flex-wrap gap-2">
                                {['Lighthouse', 'Web Vitals', 'Next.js', 'Perf tooling'].map((x) => (
